...
class Notification:
    ...
    def update(self):
        ...
        self.alpha = max(0, self.alpha - 255 / 60)  # Fade out over ~1 second
...
class PlayingState(GameState):
    ...
    def draw(self, facade, screen):
        ...
        # Draw Pause button
        pygame.draw.rect(screen, (255, 165, 0), self.pause_button)  # Orange button
        pygame.draw.rect(screen, (0, 0, 0), self.pause_button, 2)  # Black border
...
class PauseState(GameState):
    ...
    def draw(self, facade, screen):
        # Draw the current game state as a frozen background
        screen.fill((135, 206, 235))
        score_text = facade.text_font.render(f"Score: {facade.game_state['score']}", True, (0, 0, 0))
        time_text = facade.text_font.render(f"Time: {facade.game_state['time'] // 60}", True, (0, 0, 0))
        boost_text = facade.text_font.render(f"Boost: {facade.game_state['cowboy'].boost_duration // 60}", True,
        ...
        # Draw semi-transparent overlay and pause UI
